...
from modules import devices, sd_hijack_optimizations, shared, sd_hijack_checkpoint, sd_hijack_taiyi, taiyi
...
class StableDiffusionModelHijack:
    ...
    def hijack(self, m):
        if type(m.cond_stage_model) == xlmr.BertSeriesModelWithTransformation:
            ...
            m.cond_stage_model = sd_hijack_taiyi.FrozenTaiyiEmbedderWithCustomWords(
