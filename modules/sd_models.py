...
def load_model(checkpoint_info=None, already_loaded_state_dict=None, time_taken_to_load_state_dict=None):
    ...
    # print("checkpoint_info.filename:",checkpoint_info.filename)
    # print(checkpoint_info.__dict__)
    # print(shared.__dict__)
    if shared.cmd_opts.config != shared.sd_default_config:
        checkpoint_config = shared.cmd_opts.config
    else:
